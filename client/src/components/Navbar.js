import {
    Anchor, Button, Header, Menu, Nav, Box, Form, TextInput, DropButton, Text
} from 'grommet'
    ...
    return (
        <Header height='xxsmall' background='brand' style={{ position: 'sticky', top: '0' }} >
                    ...
                    dropContent={
                        <Box pad='medium'>
                            ...
                            <Button 
                                icon={<DocumentUser />}
                                label='Portfolio'
                                href='https://andersjbe.github.io/portfolio/'
                                target='_blank'
                                margin='xsmall'
                            />
            ...
            <Nav margin='small' direction='row'>
                ...
                <Menu
                    label={<Box>
                        <ImageStamp round='full' size='small' src={auth.image_url} plain />
                    </Box>}
                    icon={false}
                    items={[
